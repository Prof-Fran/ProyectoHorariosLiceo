...
- Falta definir clases y componentes visuales para:
  ...
  - `.badge-grupo-ocupado` (badge compacto que muestra el grupo `7°1`, `8°2`, etc.).
...
| **Ocupado en Otro Grupo** (Interno) | 🔵 Azul Liceo (`#3b82f6`) con Badge | Badge con Grupo: **`7°1`** o **`7°2`** + icono liceo | `"Ocupado en el liceo: Grupo 7°1 (Matemática)"` |
...
1. En `_resaltarCeldasDisponibles()`:
...
- Re-ejecutar `_actualizarInterfaz()` para repintar las celdas en base exclusivamente al `_horarioGrupo` del grupo actual, eliminando todos los badges de ocupación temporal.
...
1. **Docente que dicta en múltiples grupos en la misma franja:** El sistema soportará concatenar o mostrar el primer grupo conflictivo.
2. **Celdas con materia asignada en el grupo actual:** Mantienen la vista de la materia actual, pero evitan la sobrescritura no deseada.
3. **Sincronización:** Al asignar una hora, la disponibilidad interna se actualiza de inmediato para subsiguientes asignaciones sin recargar la página.
...
| :--- | :--- | :--- |
| **CP-01** | Seleccionar docente con horas asignadas en `7°1` mientras se arma `7°4`. | En las horas donde dicta en `7°1`, la celda muestra badge azul `7°1` y tooltip `"Ocupado en el liceo: Grupo 7°1 (Materia)"`. |
...
## 7. 📁 Archivos Involucrados en la Futura Implementación

1. [modulos/armado.js](file:///c:/Users/Cliente/Desktop/Proyectos/Proyecto%20Horarios/modulos/armado.js)
2. [css/horario.css](file:///c:/Users/Cliente/Desktop/Proyectos/Proyecto%20Horarios/css/horario.css)
3. [TAREAS.md](file:///c:/Users/Cliente/Desktop/Proyectos/Proyecto%20Horarios/TAREAS.md)
